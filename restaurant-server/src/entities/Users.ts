...
export class Users extends ParentEntity{
    ...
    @Column({type: "varchar",length: 45,nullable: false}) email: string;

    @Column({type: "varchar",length: 15,nullable: false}) phone: string;

    @Column({type: "varchar",length: 500,nullable: false}) password: string;
